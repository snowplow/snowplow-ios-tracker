...
BUILD_DEST_IOS="platform=iOS Simulator,OS=${IOS:-13.4},name=iPhone 11 Pro"
BUILD_DEST_PAIRED="platform=iOS Simulator,OS=${IOS:-13.4},name=iPhone 11 Pro"
BUILD_DEST_WATCH="platform=watchOS Simulator,OS=${WATCHOS:-6.2},name=Apple Watch Series 5 - 44mm"
